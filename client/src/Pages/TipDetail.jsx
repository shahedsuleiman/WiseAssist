    ...
    <>
      ...
      <div style={{ width: "100%" }}>
        <div class=" px-4 sm:px-6 lg:px-8 mx-auto ">
          <div class="grid lg:grid-cols-1 gap-y-8 lg:gap-y-0 lg:gap-x-6 ">
            <div class="lg:col-span-2">
              <div class="py-8 lg:pe-4 lg:pe-8 w-full">
                <div class="space-y-5 lg:space-y-8">
                  ...
                  <h2 class="text-2xl font-bold text-indigo-950 lg:text-5xl dark:text-white">
                    Stop Facebook Memories Before They Have a Chance to Pop Up
                  </h2>
                  <br />

                  <p class="text-3xl text-gray-800 dark:text-gray-200">
                    Facebook Memories can be fun, or they can resurface
                    something regrettable.
                  </p>

                  <p class="text-lg text-gray-800 dark:text-gray-200">
                    Facebook Memories can be good for a laugh, a fond memory or
                    a cringe from your high school days. But they might also
                    bring back painful or otherwise less enjoyable memories for
                    some people. Instead of being caught off guard by
                    regrettable memories, you can customize your Facebook
                    settings to hide them.
                  </p>
                  ...
                  <ul class="list-disc list-outside space-y-5 ps-5 text-lg text-gray-800 dark:text-gray-200">
                    <li class="ps-2">Open the Facebook app on your phone.</li>
                    <li class="ps-2">
                      Tap the Menu button. On Android it will be in the
                      top-right corner of the screen, and on iPhone it will be
                      in the bottom-right corner.
                    </li>
                    <li class="ps-2">Tap Memories.</li>
                    <li class="ps-2">
                      Tap the Gear icon in the top-right corner to access
                      Memories Settings.
                    </li>
                    <li class="ps-2">
                      You can choose between All Memories, Highlights or None.
                      All Memories means Facebook will show you all your
                      memories from that day, Highlights will only show you
                      special videos and collections, and None means you won't
                      get notifications for any memories.
                    </li>
                  </ul>

                  <p class="text-lg text-gray-800 dark:text-gray-200">
                    If you want something more specific, you can choose to hide
                    memories involving specific users. Follow the steps above,
                    but instead tap People in the Memories Settings page. You
                    can type in a user's name that you want to hide from your
                    memories. They won't be notified, and your selections are
                    saved automatically. You can also tap Dates in the Memories
                    Settings page to hide memories from a specific date range.
                    You can enter almost any span of time -- a day, a week,
                    month or an entire year -- going back in time to 1900. When
                    you're done, tap Done and then tap Save.
                  </p>
